...
const aSQLPadrao: String = 'SELECT CD_ESTADOS CD_CADASTRO, '+
                           'DS_ESTADOS DS_CADASTRO, '+
                           'SIGLA ' +
                           'FROM ESTADOS '+
                           'ORDER BY DS_ESTADOS';
...
begin
  ...
  FDMTPadrao.FieldDefs.Add('DS_ESTADOS', ftString, 40, False);//adicionamos campos
